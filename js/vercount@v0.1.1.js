...
!function() {
    ...
    t = {
        fetch: async function(t) {
            ...
            try {
                ...
                let i = s;
                i = i.replace(window.location.hostname, hostname)
                ...
                try {
                    ...
                    const s = (t => {
                        if (t && t.status) {
                            ...
                            if ("error" === t.status && t.data)
                                return console.warn(`API error: ${t.message}`, t),
                                t.data;
                            if ("error" === t.status)
                                return console.warn(`API error: ${t.message}`, t),
                                {
                    ...
                    n(( () => {
                        t(s),
                        localStorage.setItem("visitorCountData", JSON.stringify(s)),
                        e.showAll()
                    }
                    ))
                } catch (o) {
                ...
                if (a)
                    try {
                        ...
                        console.error("Error parsing cached data:", t),
                        e.hideAll()
                    }
                else
                    e.hideAll()
    ...
    (n = function(t) {
        a || "interactive" === document.readyState || "complete" === document.readyState ? t.call(document) : (o.push(t),
